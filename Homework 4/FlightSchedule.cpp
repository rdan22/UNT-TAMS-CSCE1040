...
void FlightSchedule::printFlightSchedule()
{
    ...
    cout << setw(10) << left << "Pilot";
    cout << setw(10) << left << "CoPilot";
    cout << setw(10) << left << "crewID1";
    cout << setw(10) << left << "crewID2";
    cout << setw(10) << left << "crewID3";
...
void FlightSchedule::saveData(ofstream& os)
{
	...
	while(it != flights.end())
    {
        ...
        os << flight->getStartDate() << ','
        	<< flight->getStartTime() << ',' << flight->getEndDate() << ','
        	<< flight->getEndTime() << ','  << flight->getStartingCode() << ','
...
void FlightSchedule::loadData(ifstream& is)
{
    ...
    for(int i = 0; i < tempCount; i++)
    {
		...
		flightInterval.setStartTime(startDate + " " + startTime);
    	flightInterval.setFinishTime(endDate + " " + endTime);
